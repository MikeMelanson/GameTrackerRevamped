        ...
        fetch('/system_publishers', {method: 'GET'}).then(res => res.json()).then(data => {
            ...
            for (let i=0;i<l;i++){
                this.setState(prevState => ({
                    publishers: [...prevState.publishers,<option key={data.publishers[0][0]} value={data.publishers[0][0]}>{data.publishers[0][0]}</option>]
                }))
            }
        });
    }
            ...
            <>
                <div>
                    ...
                    <form onSubmit={this.handleSubmit} method='post'>
                        <label htmlFor='name'>Name:</label><input type='text' id='name' onChange={this.handleNameChange}></input>
                        ...
                        <label htmlFor='pricePaid'>Price Paid:</label><input type='number' id='pricePaid' onChange={this.handlePricePaidChange}></input>
                        ...
                        <label htmlFor='numOwned'>Number Owned:</label><input type='number' id='numOwned' onChange={this.handleOwnedChange}></input>
                        <label htmlFor='numCont'>Number of Controllers:</label><input type='number' id='numCont' onChange={this.handleNumContChange}></input>
